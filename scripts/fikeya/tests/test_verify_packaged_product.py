...
class PackagedProductVerificationTests(unittest.TestCase):
    ...
    def test_accepts_separate_runtime_and_distribution_versions(self) -> None:
        verify_runtime_version_identity(
            {
                "version": "1.136.0",
                "distributionVersion": "0.1.0-beta.6",
            },
            {
                "version": "1.136.0",
                "distributionVersion": "0.1.0-beta.6",
        ...
        verify_windows_executable_metadata(
            {
                ...
                "fileVersion": "0.1.0.6",
                "productVersion": "0.1.0-beta.6",
                "fileVersionRaw": "0.1.0.6",
                "productVersionRaw": "0.1.0.6",
                "authenticodeStatus": "NotSigned",
            },
            public_version="0.1.0-beta.6",
            numeric_version="0.1.0.6",
        )
