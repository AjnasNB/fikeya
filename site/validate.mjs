...
assert(html.includes('src="/fikeya-desktop-memory.png"'), 'Real memory capture is missing');
assert(html.includes('src="/fikeya-desktop-editor.png"'), 'Real editor capture is missing');
